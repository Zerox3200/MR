    ...
    return <div className='Order py-6'>
        ...
        <form className='text-right mt-10 flex flex-col justify-center'>
            <div class="grid gap-6 mb-6 md:grid-cols-2 px-6">
                <div>
                    <label for="first_name" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">الأسم</label>
            ...
            <button type="submit" class="text-white bg-blue-700 focus:ring-4 focus:outline-none focus:ring-blue-300
